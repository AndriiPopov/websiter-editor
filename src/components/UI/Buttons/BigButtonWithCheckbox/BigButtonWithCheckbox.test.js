...
test('BigButtonWithCheckbox can be rendered with title and icon', () => {
    // Arrange
...
test('BigButtonWithCheckbox can be rendered without title and icon', () => {
    // Arrange
    const container = render(<BigButtonWithCheckbox />)
