...
function isMobile(userAgent) {
    var ua =
        userAgent ||
        (typeof navigator !== 'undefined' ? navigator.userAgent : '') // Facebook mobile app's integrated browser adds a bunch of strings that
    ...
    result.any =
        ...
        result.other.device // excludes 'other' devices and ipods, targeting touchscreen phones
